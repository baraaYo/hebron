...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-554.648021, -582.555355, 179512.311400, 130471.463700], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:28191',
            extent: [-554.648021, -582.555355, 179512.311400, 130471.463700],
            units: 'm'})
    })
});
...
map.getView().fit([-554.648021, -582.555355, 179512.311400, 130471.463700], map.getSize());
